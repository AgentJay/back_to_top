...
class BackToTopSettingsForm extends ConfigFormBase {
	...
	public function buildForm(array $form, array &$form_state) {
		...
		$form['#attached']['css'] = array(
			drupal_get_path('module', 'back_to_top') . '/css/back_to_top.admin.css',
		);

		$form['#attached']['js'] = array(
			drupal_get_path('module', 'back_to_top') . '/js/back_to_top.admin.js',
		);
	...
	public function submitForm(array &$form, array &$form_state) {
		$config = $this->configFactory->get('back_to_top.settings');
